...
| 维度 | 权重 | 最新数据 | 趋势 | 对标的的影响 | 维度评分(0-100) |
|------|------|---------|------|------------|:---:|
| 市场方向 | 25% | 指数点位+涨跌 | ↑/→/↓ | 利好/中性/利空 | **XX** |
| 风险情绪 | 20% | VIX/利差 | ↑/→/↓ | 利好/中性/利空 | **XX** |
| 经济增长 | 20% | PMI/GDP | ↑/→/↓ | 利好/中性/利空 | **XX** |
| 利率环境 | 20% | LPR/社融 | ↑/→/↓ | 利好/中性/利空 | **XX** |
| 通胀趋势 | 15% | CPI/PPI | ↑/→/↓ | 利好/中性/利空 | **XX** |
...
| 检查项 | 要求 | ✅/❌ |
|--------|------|------|
| 五大维度全覆盖 | 每个维度有最新数据 + 评分 | |
| 对标的的影响明确 | 每条判断有具体传导路径 | |
| JSON 输出完整 | 6 个字段齐全 | |
| 未讨论个股基本面/技术面 | 全文不出现 PE/ROE/RSI/MACD | |
| 来源数量 | ≥ 3 个独立来源 | |
| 章节结构 | ≥ 3 个 ## 级别章节 | |
| 内容长度 | ≥ 2000 字符 | |
